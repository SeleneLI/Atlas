...
STRAT_TIME = '2016-08-01 16:53:00'
STOP_TIME = '2016-08-01 17:03:00'
...
def ping(target, mes_id_file):
    ...
    interval = 300 # default value is 240 seconds; In normal (not one-off) measurements, this value represents the number of seconds between measurements by a single probe.
...
if __name__ == "__main__":
    ...
    target_site_l = ['193.51.224.144', '125.39.240.113']

    # When you want to try the whold scall of website, use the command below
    # target_site_l =[]
    # exp_input = 'exp_input.csv'
    # with open(exp_input) as exp_handler:
    #     reader = csv.reader(exp_handler, delimiter=';')
    #     for csv_line in map(list, reader):
    #         target_site_l.append(csv_line[1])
