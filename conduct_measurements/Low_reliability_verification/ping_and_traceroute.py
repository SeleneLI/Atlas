...
MEASUREMENT_NAME = 'Low_reliability_verification'
...
STRAT_TIME = '2017-10-25 13:00:00'
STOP_TIME = '2017-10-26 12:55:00'
...
#                 print "Due to traceroute_v6, cannot launch mesurement for {0}".format(target)
    ...
    with open(MES_ID_PING_V4_FILE, 'w') as ping_v4_file, open(MES_ID_TRACEROUTE_V4_FILE, 'w') as traceroute_v4_file:
        # target_site_l = [str(e) for e in target_site_v4_l]
        for target in target_site_v4_l:
            try:
                ping_v4(target, ping_v4_file)
